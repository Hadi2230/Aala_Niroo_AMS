<?php
/**
 * request_management_modern.php - مدیریت درخواست‌های کالا/خدمات - نسخه مدرن و حرفه‌ای
 */
    ...
    if ($_POST['action'] === 'create_request') {
        try {
            ...
            if (!empty($request_ids)) {
                ...
                header('Location: request_management_modern.php');
                exit();
            } else {
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="request_tracking.php">
    ...
    <div class="main-container">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="stats-card" onclick="showCreateForm()">
                        ...
                        <p class="mb-0">درخواست کالا یا خدمات جدید ایجاد کنید</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="stats-card" onclick="window.location.href='request_tracking.php'">
                        <i class="fas fa-search icon-large"></i>
                        <div class="stats-title">پیگیری درخواست‌ها</div>
                        <p class="mb-0">وضعیت درخواست‌های خود را بررسی کنید</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="stats-card" onclick="showReports()">
                        ...
                        <p class="mb-0">گزارش‌های آماری و تحلیلی</p>
                    </div>
                </div>
            </div>
            ...
            <div class="loading" id="loading">
                ...
                <p class="mt-3">در حال پردازش درخواست...</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function addAssignment() {
            ...
            if (userSelect.value && departmentInput.value) {
                ...
                assignment.innerHTML = `
                    <div>
                        <strong>${userSelect.options[userSelect.selectedIndex].text}</strong>
                        <br>
        ...
        document.getElementById('requestForm').addEventListener('submit', function(e) {
            ...
            fetch('request_management_modern.php', {
                method: 'POST',
                body: formData
            })
