...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_asset'])) {
    ...
    try {
        ...
        $purchase_date = jalaliToGregorianForDB(sanitizeInput($_POST['purchase_date']));
        ...
        $workshop_entry_date = jalaliToGregorianForDB(sanitizeInput($_POST['workshop_entry_date'] ?? ''));
        $workshop_exit_date = jalaliToGregorianForDB(sanitizeInput($_POST['workshop_exit_date'] ?? ''));
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control jalali-date" id="purchase_date" name="purchase_date" 
                                               placeholder="تاریخ خرید (مثال: 1403/01/15)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control jalali-date" id="workshop_entry_date" name="workshop_entry_date" 
                                                   placeholder="تاریخ ورود به کارگاه (مثال: 1403/01/15)" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="workshop_exit_date" class="form-label">تاریخ خروج از کارگاه</label>
                                            <input type="text" class="form-control jalali-date" id="workshop_exit_date" name="workshop_exit_date" 
                                                   placeholder="تاریخ خروج از کارگاه (مثال: 1403/01/15)" readonly>
                                        </div>
                                    </div>
                                </div>
