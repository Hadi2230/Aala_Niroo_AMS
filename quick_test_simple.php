...
// تست 3: توابع تاریخ
try {
    if (function_exists('jalaliToGregorianForDB') && function_exists('gregorianToJalaliFromDB')) {
        $jalali = '1403/01/01';
        ...
        $tests[] = ['name' => 'توابع تاریخ شمسی', 'status' => 'error', 'message' => 'توابع تعریف نشده‌اند'];
        $overall_ok = false;
    }
} catch (Exception $e) {
...
try {
    if (function_exists('logAction')) {
        ...
        $tests[] = ['name' => 'سیستم لاگ', 'status' => 'error', 'message' => 'تابع logAction تعریف نشده'];
        $overall_ok = false;
    }
} catch (Exception $e) {
        ...
        <div class="page-header">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="mb-0">
                            <i class="fas fa-tachometer-alt me-3"></i>تست سریع سیستم
                        </h1>
                        <p class="mb-0 mt-2">بررسی سریع وضعیت سیستم</p>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="text-center mt-4">
                    <a href="system_test_simple.php" class="btn btn-primary me-2">
                        <i class="fas fa-stethoscope me-2"></i>تست کامل سیستم
                    </a>
                    <button class="btn btn-success" onclick="location.reload()">
                        <i class="fas fa-sync-alt me-2"></i>تست مجدد
                    </button>
