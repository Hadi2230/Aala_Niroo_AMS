                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control jalali-date" id="assignment_date" name="assignment_date" required 
                                       placeholder="تاریخ انتساب (مثال: 1403/01/15)" 
                                       value="<?php echo jalaliDate(null, 'Y/m/d'); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="installation_date" name="installation_date" 
                                           placeholder="تاریخ نصب (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="warranty_start_date" name="warranty_start_date" 
                                           placeholder="تاریخ آغاز گارانتی (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="installation_start_date" name="installation_start_date" 
                                           placeholder="تاریخ آغاز نصب (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="installation_end_date" name="installation_end_date" 
                                           placeholder="تاریخ اتمام نصب (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="temporary_delivery_date" name="temporary_delivery_date" 
                                           placeholder="تاریخ تحویل موقت (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="permanent_delivery_date" name="permanent_delivery_date" 
                                           placeholder="تاریخ تحویل دائم (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control jalali-date" id="first_service_date" name="first_service_date" 
                                           placeholder="تاریخ سرویس اولیه (مثال: 1403/01/15)" readonly>
                                </div>
                            </div>
                        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $assignment['assignment_date'] ? gregorianToJalaliFromDB($assignment['assignment_date']) : '--'; ?></td>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>تاریخ انتساب:</strong> <?php echo $assignment['assignment_date'] ? gregorianToJalaliFromDB($assignment['assignment_date']) : '--'; ?></p>
                        ...
                        <div class="col-md-6">
                            <p><strong>تاریخ نصب:</strong> <?php echo $assignment_details['installation_date'] ? gregorianToJalaliFromDB($assignment_details['installation_date']) : '--'; ?></p>
                            <p><strong>تاریخ آغاز گارانتی:</strong> <?php echo $assignment_details['warranty_start_date'] ? gregorianToJalaliFromDB($assignment_details['warranty_start_date']) : '--'; ?></p>
                            <p><strong>نام نصاب:</strong> <?php echo $assignment_details['installer_name']; ?></p>
                            <p><strong>تاریخ تحویل موقت:</strong> <?php echo $assignment_details['temporary_delivery_date'] ? gregorianToJalaliFromDB($assignment_details['temporary_delivery_date']) : '--'; ?></p>
                            <p><strong>تاریخ تحویل دائم:</strong> <?php echo $assignment_details['permanent_delivery_date'] ? gregorianToJalaliFromDB($assignment_details['permanent_delivery_date']) : '--'; ?></p>
                        </div>
                    </div>
