...
.nav-item{opacity:0; transform:translateY(10px); transition:all .45s cubic-bezier(.2,.9,.2,1);} .nav-item.show{opacity:1; transform:none;}
...
.nav-link i{font-size:1.28rem; color:var(--icon-color); transition:transform .25s ease, text-shadow .25s;} .nav-link:hover i{transform:scale(1.35); text-shadow:0 0 14px rgba(0,0,0,.15); color:var(--icon-color);} .nav-link span{font-size:.72rem; color:var(--nav-text);} 
.nav-link[data-bs-title]::after{content: attr(data-bs-title); position:absolute; bottom:-36px; left:50%; transform:translateX(-50%) scale(.96); background:var(--tooltip-bg); color:#fff; font-size:.68rem; padding:.28rem .6rem; border-radius:6px; white-space:nowrap; opacity:0; pointer-events:none; transition:opacity .28s, transform .28s; z-index:30;}
...
.dropdown-item{color:var(--dropdown-text); padding:.45rem .9rem; transition:background .18s;} .dropdown-item:hover{background:rgba(0,0,0,0.06); color:var(--dropdown-text);} 
.position-relative{position:relative;}
.search-input{background:var(--search-bg); border:none; border-radius:20px; color:var(--text); padding:.32rem .9rem .32rem 2rem; width:150px; transition:all .28s; font-size:.75rem;} .search-input::placeholder{color:var(--search-placeholder);} .search-input:focus{outline:none; box-shadow:0 0 0 4px var(--focus-ring); width:190px;}
...
/* Mega Menu */
.mega-menu{ position:absolute; top:100%; left:0; min-width:560px; background:var(--dropdown-bg); color:var(--dropdown-text); border-radius:10px; box-shadow:0 10px 30px rgba(0,0,0,0.15); padding:20px; z-index:1000; display:none; margin-top:10px; }
...
.menu-card i{font-size:22px; margin-bottom:8px; color:#3498db;} .menu-card h6{margin:0; font-weight:700; color:#2c3e50; font-size:.92rem;} .menu-card p{font-size:.75rem; color:#6c757d; margin:6px 0 0;}
.menu-card.workflow{background:var(--dropdown-bg); color:var(--dropdown-text); border-radius:8px; padding:14px; transition:all .28s ease; border:1px solid #e9ecef; text-align:center; text-decoration:none;}
.menu-card.workflow:hover{background:#e9ecef; transform:translateY(-3px); box-shadow:0 5px 15px rgba(0,0,0,0.1);} .menu-card.workflow i{font-size:22px; margin-bottom:8px; color:#3498db;} .menu-card.workflow h6{margin:0; font-weight:700; color:#2c3e50; font-size:.92rem;} .menu-card.workflow p{font-size:.75rem; color:#6c757d; margin:6px 0 0;}
html[data-theme="dark"] .menu-card{background:#1a2235; border-color:#2d3748;} html[data-theme="dark"] .menu-card:hover{background:#222b3f;} html[data-theme="dark"] .menu-card h6{color:#e6eef8;} html[data-theme="dark"] .menu-card p{color:#a0aec0;}
html[data-theme="dark"] .menu-card.workflow{background:#1a2235; border-color:#2d3748;} html[data-theme="dark"] .menu-card.workflow:hover{background:#222b3f;} html[data-theme="dark"] .menu-card.workflow h6{color:#e6eef8;} html[data-theme="dark"] .menu-card.workflow p{color:#a0aec0;}
</style>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMain">
      <ul class="navbar-nav me-auto">
        ...
        <!-- Training Mega -->
        <li class="nav-item position-relative">
          <a class="nav-link<?php echo $trainingActive; ?>" href="#" id="trainingMenuTrigger">
            <i class="fas fa-graduation-cap"></i><span class="lang" data-fa="آموزش" data-en="Training"></span>
          </a>
          <div class="mega-menu" id="trainingMegaMenu" aria-labelledby="trainingMenuTrigger">
            <div class="menu-grid">
              <a href="training.php" class="menu-card">
                <i class="fas fa-graduation-cap"></i>
                <h6 class="lang" data-fa="مرکز آموزش" data-en="Training Hub"></h6>
                <p class="lang" data-fa="مرور همه بخش‌های آموزشی" data-en="Browse all sections"></p>
              </a>
              <a href="training_forms.php" class="menu-card">
                <i class="fas fa-file-alt"></i>
                <h6 class="lang" data-fa="فرم‌های شرکت" data-en="Company Forms"></h6>
                <p class="lang" data-fa="دانلود فرم‌ها و قراردادها" data-en="Download forms & contracts"></p>
              </a>
              <a href="training_gallery.php" class="menu-card">
                <i class="fas fa-images"></i>
                <h6 class="lang" data-fa="تصاویر آموزشی" data-en="Image Gallery"></h6>
                <p class="lang" data-fa="مشاهده و دانلود تصاویر" data-en="View & download images"></p>
              </a>
              <a href="training_videos.php" class="menu-card">
                <i class="fas fa-video"></i>
                <h6 class="lang" data-fa="ویدیوهای آموزشی" data-en="Training Videos"></h6>
                <p class="lang" data-fa="تماشای آموزش‌های ویدیویی" data-en="Watch training videos"></p>
              </a>
              <a href="training_articles.php" class="menu-card">
                <i class="fas fa-newspaper"></i>
                <h6 class="lang" data-fa="مقالات و نشریات" data-en="Articles & Publications"></h6>
                <p class="lang" data-fa="مطالعه و دانلود مقالات" data-en="Read & download articles"></p>
              </a>
            </div>
          </div>
        </li>
