<?php
// test_visit_final.php - تست نهایی سیستم بازدید
...
try {
    ...
    if (strpos($content, 'Bootstrap') !== false) {
        echo "<div class='success'>✅ Bootstrap موجود است</div>";
    }
...
echo "<a href='visit_dashboard.php' target='_blank' class='btn'>🏠 داشبورد بازدیدها</a>";
echo "<a href='visit_management.php' target='_blank' class='btn'>📋 مدیریت بازدیدها</a>";
echo "<a href='visit_checkin.php' target='_blank' class='btn'>📱 Check-in موبایل</a>";
echo "<a href='visit_details.php?id=1' target='_blank' class='btn'>🔍 جزئیات بازدید</a>";
