...
<body>
        ...
        <div class="content-area">
            ...
            <div class="global-controls" data-aos="fade-up">
                ...
                <div class="global-controls-grid">
                    ...
                    <a href="test_earthcam.php" class="global-btn" target="_blank">
            ...
            <div class="camera-grid" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="camera-card">
                    ...
                    <div class="camera-container">
                        <div class="camera-loading" id="loading1">
                ...
                <div class="camera-card">
                    ...
                    <div class="camera-container">
                        <div class="camera-loading" id="loading2">
                            <i class="fas fa-spinner"></i>
                            <div>در حال بارگذاری...</div>
                        </div>
                        <iframe 
                ...
                <div class="camera-card">
                    ...
                    <div class="camera-container">
                        <div class="camera-loading" id="loading3">
                            <i class="fas fa-spinner"></i>
                            <div>در حال بارگذاری...</div>
                        </div>
                        <iframe 
                ...
                <div class="camera-card">
                    ...
                    <div class="camera-container">
                        <div class="camera-loading" id="loading4">
                            <i class="fas fa-spinner"></i>
                            <div>در حال بارگذاری...</div>
                        </div>
                        <iframe 
    ...
    <script>
        ...
        function toggleCamera(cameraId) {
            ...
            const btn = document.querySelector(`#${cameraId}`).closest('.camera-card').querySelector('.control-btn');
